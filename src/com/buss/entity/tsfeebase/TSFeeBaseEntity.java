package com.buss.entity.tsfeebase;
 ...
 */
@Entity
@Table(name = "t_s_fee_base", schema = "")
@SuppressWarnings("serial")
public class TSFeeBaseEntity implements java.io.Serializable {
	/**主键*/
	...
	@Column(name ="FEE_FIEDS",nullable=true,length=255)
