...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="tSFeeBaseController.do?doAdd">
		...
		<tr>
			...
			<td class="value">
					<t:dictSelect field="feeType" type="list"
						typeGroupCode="fee_type"  hasLabel="false"  title="费用类别"></t:dictSelect>     
			...
			<td class="value">
		     	 <input id="feeFieds" name="feeFieds" type="text" style="width: 150px" class="inputxt">
				<span class="Validform_checktip"></span>
