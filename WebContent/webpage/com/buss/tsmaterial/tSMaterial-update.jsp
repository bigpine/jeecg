...
<html>
 ...
 <body style="overflow-x: hidden;">
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" tiptype="1" action="tSMaterialController.do?doUpdate">
	...
	<table cellpadding="0" cellspacing="1" class="formtable">
		<tr>
			...
			<td class="value">
					<t:dictSelect field="itemName" type="list"
						typeGroupCode="subject" defaultVal="${tSMaterialPage.itemName}" hasLabel="false"  title="科目"></t:dictSelect>     
			...
			<td class="value">
		     	 <input id="itemDetail" name="itemDetail" type="text" style="width: 150px" class="inputxt" value='${tSMaterialPage.itemDetail}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="standard" name="standard" type="text" style="width: 150px" class="inputxt" value='${tSMaterialPage.standard}'>
				<span class="Validform_checktip"></span>
			...
			<td class="value">
		     	 <input id="price" name="price" type="text" style="width: 150px" class="inputxt" value='${tSMaterialPage.price}'>
				<span class="Validform_checktip"></span>
		...
		<tr>
			...
			<td class="value">
		     	 <input id="supplier" name="supplier" type="text" style="width: 150px" class="inputxt" value='${tSMaterialPage.supplier}'>
				<span class="Validform_checktip"></span>
