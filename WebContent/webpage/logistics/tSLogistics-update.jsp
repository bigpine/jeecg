...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="tSLogisticsController.do?doUpdate" tiptype="1">
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="tCompany" name="tCompany" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tSLogisticsPage.tCompany}'>
						...
						<td class="value">
						     	 <input id="tSalesCode" name="tSalesCode" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tSLogisticsPage.tSalesCode}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="tSalesTitle" name="tSalesTitle" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tSLogisticsPage.tSalesTitle}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="tSendCode" name="tSendCode" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tSLogisticsPage.tSendCode}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="tSendTitle" name="tSendTitle" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tSLogisticsPage.tSendTitle}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="tShipAdd" name="tShipAdd" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tSLogisticsPage.tShipAdd}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="tInvoiceAdd" name="tInvoiceAdd" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tSLogisticsPage.tInvoiceAdd}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="tReceipt" name="tReceipt" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tSLogisticsPage.tReceipt}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="tSendReq" name="tSendReq" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tSLogisticsPage.tSendReq}'>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						     	 <input id="tBinning" name="tBinning" type="text" style="width: 150px" class="inputxt"  
										       ...
										       value='${tSLogisticsPage.tBinning}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						  	 	<textarea id="tCustomerOther" style="width:600px;" class="inputxt" rows="6" name="tCustomerOther">${tSLogisticsPage.tCustomerOther}</textarea>
							<span class="Validform_checktip"></span>
						...
						<td class="value">
						  	 	<textarea id="tDesc" style="width:600px;" class="inputxt" rows="6" name="tDesc">${tSLogisticsPage.tDesc}</textarea>
							<span class="Validform_checktip"></span>
